package net.codeengine.windowmanagement {
    ...
    public class Window extends net.codeengine.windowmanagement.WindowBackground implements IWindow {
        ...
        [Bindable] private var _showMaximizeButton:Boolean=true;

        [Bindable] private var _showMinimizeButton:Boolean=true;

        [Bindable] private var _showResizeHandle:Boolean=true;

        [Bindable] private var buttonMinimize:Image=new Image();

        [Bindable] private var buttonMaximize:Image=new Image();

        [Bindable] private var buttonClose:Image=new Image();

        [Bindable] private var buttonResize:Image=new Image();
        ...
        [Bindable] public var resizeCursor:Class;
        ...
        [Inspectable(category="General")]
        [Bindable] public function get windowManager():IWindowManager {
        ...
        public function block():void {
            if (this.isSheetActive) {
                (this.sheet as Object).enabled=false;
            }
            if (this.isDrawerActive) {
